...
shell(
    "("
    "wget https://dohlee-bioinfo.sgp1.digitaloceanspaces.com/test-data/rna-seq/pe/test.read1.fastq.gz -qO {read1_wget_output} && "
    "{read1_gunzip_command} && "
    "wget https://dohlee-bioinfo.sgp1.digitaloceanspaces.com/test-data/rna-seq/pe/test.read2.fastq.gz -qO {read2_wget_output} && "
    "{read2_gunzip_command}"
    ")"
)
